...
plotOutput('indmap') %>% withSpinner(proxy.height = "300px")
```
...
plotOutput('indtab1') %>% withSpinner(proxy.height = "650px")
```
...
plotOutput('indtab2') %>% withSpinner(proxy.height = "600px")
```
...
plotOutput('indtab3') %>% withSpinner(proxy.height = "600px")
```
...
plotOutput('indtab4') %>% withSpinner(proxy.height = "600px")
```
...
plotOutput('indtab5') %>% withSpinner(proxy.height = "250px")
```
...
plotOutput('allplo1') %>% withSpinner(proxy.height = "400px")
```
...
plotOutput('allplo2') %>% withSpinner(proxy.height = "450px")
```
