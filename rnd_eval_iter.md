...
## Similar locations, random dates, random project types (n = 50)
...
# run
outall2 <- foreach(i = 1:n, .packages = c('tidyr', 'dplyr', 'raster', 'sp', 'rgeos', 'tibble', 'rgdal', 'purrr', 'geosphere')) %dopar% {
...
save(outall2, file = 'data/outall2.RData', compress = 'xz')
```
...
![](rnd_eval_iter_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
