...
typelev <- c('non_src', 'pnt_src', 'hab_enh', 'hab_est', 'hab_pro')
typelab <- c('Nonpoint control', 'Point control', 'Habitat enhance', 'Habitat establish', 'Habitat protect')
typecol <- c('#3182bd', '#9ecae1', '#31a354', '#74c476' , '#c7e9c0')
```
...
```{r restyrs, fig.height = 6.5, fig.width = 8, fig.cap = "Counts (top) and locations (bottom) of restoration project types over time in the Tampa Bay watershed.  Restorations were categorized as water infrastructure (nonpoint source controls, point source controls) and habitat (enhancements, establishments, protection) projects.  The compiled restoration database included records of project types and locations from 1971 to 2017."}
...
# combine plots
grid.arrange(p1, p2, ncol = 1, heights = c(1, 0.7))
```
