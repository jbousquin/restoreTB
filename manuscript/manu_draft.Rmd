...
tab <- regulartable(totab) %>% 
  ...
  add_header(salgrp = '', grpagg = '', `tn, minv` = 'Total Nitrogen (mg/L)', `tn, medv` = 'Total Nitrogen (mg/L)', `tn, maxv` = 'Total Nitrogen (mg/L)', `chla, minv` = 'Chlorophyll-a (ug/L)', `chla, medv` = 'Chlorophyll-a (ug/L)', `chla, maxv` = 'Chlorophyll-a (ug/L)') %>% 
  merge_h(part = 'header') %>% 
