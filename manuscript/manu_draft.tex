...
changes for each of \(n\) spatially matched restoration projects. For
...
water quality before after each project was then divided by the total
number of \(n\) matched projects, muliplied the distance of the projects
from a water quality station (\(dist_{i \in n}\)). This created weighted
average of the before/after effects of each project that was inversely
related to the distance from a watwer quality station. The total change
in water quaility was simply the difference in weighted averages.
