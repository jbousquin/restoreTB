...
column(width = 12, 
  ...
  column(width = 6, 
    ...
    renderUI({
      ...
      selectInput("mtch1", label = 'Select first number of restoration matches:', choices = mtch, selected = max(mtch))
  ...
  column(width = 6, 
    ...
    renderUI({
      ...
      selectInput("mtch2", label = 'Select second number of restoration matches:', choices = mtch, selected = max(mtch))
